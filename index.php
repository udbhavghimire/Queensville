...
<head>
    ...
    <title>Queensville Towns & Singles | Register Today</title>
    <meta name="title" content="Queensville Towns & Singles | Register Today">
    <meta name="description"
        content="Explore a new community of Townhomes and Single Family Homes by trusted builders like Aspenridge, Lakeview Homes, and Countrywide, coming soon to Queensville. New release of towns & singles with comfort, style, and convenience in this master-planned neighborhood">
    <meta name="keywords"
        content="Queensville Towns, Queensville Singles, Aspen Ridge Homes, CountryWide, Lakeview Homes">
    <meta name="robots" content="index, follow">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="language" content="English">
    <meta name="revisit-after" content="1 days">
    <meta property="og:image" content="https://thequeensville.ca/images/1.jpg">


    <meta property="og:site_name" content="Queensville Towns & Singles" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebSite",
            "name": "Queensville Towns & Singles",
            "url": "https://thequeensville.ca/"
        }
    </script>
    <!-- Google tag (gtag.js) -->
        ...
        <div class="container" id="hero">
            <div class="row me-0 row-cols-1 row-cols-md-2 d-flex align-items-center pt-md-5 pt-1 gx-md-5">
                    ...
                    <div>
                        ...
                        <div class="pt-2 pt-sm-2 mt-md-1 rounded-mine mt-2 px-md-0 px-2">
                            <p class="headline-textt headline-textt-sm">
                                ...
                                is a new pre-construction development in Queensville, ON. This master-planned community
                                offers
                                townhomes and single-family homes by renowned builders Aspen Ridge Homes, CountryWide,
                                and
                            ...
                            <div class=" d-block fs-5 pt-1 center-sm">
                                ...
                                <p class="mybot pb-md-0 pb-0">
                                    Address: 19841 Leslie St., Queensville
                                </p>
                                <p class="mybot pb-md-0 pb-0">
                                    Occupancy: Est. 2025
                                </p>
                ...
                <div class="col position-relative order-1 order-md-2 ps-md-5 ps-0 mx-2 px-2 mx-md-0">
                    <video id="myVideo" class="img-fluid" autoplay muted loop playsinline>
                        <source src="images/Videos_Queensville_Web_Interior2.mp4" type="video/mp4">
                        <!-- Fallback image in case video doesn't load -->
                        <img src="images/1.jpg" class="img-fluid" alt="Queensville Towns & Singles">
                    </video>
                </div>
            </div>
        </div>
        ...
        <div class="container pt-md-2">
            ...
            <div>
                <div class="row row-cols-2 row-cols-md-2 row-cols-lg-3 justify-content-center gy-md-4 gy-3 gx-3">
                    <div class="col">
                        <div href="#" class="afte">
                            <img src="images/1.jpg" alt="Queensville Towns & Singles"
                                class="img-fluid rounded-mine imghei" />
                        </div>
                    </div>
                    <div class="col">
                        <div class="afte">
                            <img src="images/2.jpg" alt="Queensville Towns & Singles"
                                class="img-fluid rounded-mine imghei" />
                        </div>
                    </div>
                    <div class="col">
                        <div class="afte">
                            <img src="images/3.jpg" alt="Queensville Towns & Singles"
                                class="img-fluid rounded-mine imghei" />
                        </div>
                    </div>
                    <div class="col">
                        <div href="#" class="afte">
                            <img src="images/4.jpg" alt="Queensville Towns & Singles"
                                class="img-fluid rounded-mine imghei" />
                        </div>
                    </div>
                    <div class="col">
                        <div href="#" class="afte">
                            <img src="images/5.jpg" alt="Queensville Towns & Singles"
                                class="img-fluid rounded-mine imghei" />
                        </div>
                    </div>
                    <div class="col">
                        <div href="#" class="afte">
                            <img src="images/6.jpg" alt="Queensville Towns & Singles"
                                class="img-fluid rounded-mine imghei" />
                        </div>
                    </div>
                    <div class="col">
                        <div href="#" class="afte">
                            <img src="images/08.jpg" alt="Queensville Towns & Singles"
                                class="img-fluid rounded-mine imghei" />
                        </div>
                    </div>
                    <div class="col">
                        <div href="#" class="afte">
                            <img src="images/9.jpg" alt="Queensville Towns & Singles"
                                class="img-fluid rounded-mine imghei" />
                        </div>
                    </div>
                    <div class="col">
                        <div href="#" class="afte">
                            <img src="images/10.jpg" alt="Queensville Towns & Singles"
                                class="img-fluid rounded-mine imghei" />
                        </div>
                    </div>
        ...
        <div class="container pt-5">
            ...
            <div>
                <div class="row row-cols-2 row-cols-md-3 justify-content-center gy-md-4 gy-4 gx-3 pt-md-2 pt-0">
                    <div class="col">
                        <div class="afte">
                            <img src="./images/blur-floorplan2.png" alt="Queensville Towns & Singles Floor Plan"
    ...
    <section class="py-md-5 py-4">
        <div class="container pt-md-5 pt-5">
            <h2 class="fw-bold fs-1 mb-4 text-center justify-content-center brand-color">
                Checkout the community video by Queensville
            </h2>
            <div class="">
                <div class="d-flex justify-content-center align-items-center video-container">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/ROPaIG4VggE?si=xRZt53Q1-a81cmFh"
        ...
        <div class="container pt-md-4 pt-0">
            ...
            <div class="py-5" id="location">
                <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center brand-color">
                    <span class="mx-1">Queensville Towns & Singles - Location</span>
                </h2>
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3">
                    19841 Leslie St., Queensville, ON
                </span>
                <div class="row row-cols-md-2 row-cols-1 text-center mx-2 mx-md-0">
                    <div class="bg-white p-1  rounded-mine d-flex justify-content-center col">
                        <img src="./images/25.jpg" class="img-fluid sitemap" alt="Queensville Towns & Singles Sitemap">
                    </div>
                    <div class="bg-white p-1 rounded-mine d-flex justify-content-center align-items-center col">

                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2863.919211310406!2d-79.44664519999999!3d44.12628850000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882acc6d407c013d%3A0xef56f2821babad7d!2s19841%20Leslie%20St%2C%20Queensville%2C%20ON%20L0L%201R0%2C%20Canada!5e0!3m2!1sen!2snp!4v1736592733956!5m2!1sen!2snp"
            ...
            <div class="accordion accordion-flush pt-4" id="accordionFlushExample">
                <div class="accordion-item">
                    <h3 class="accordion-header" id="flush-headingOne">
                        <button class="accordion-button collapsed fs-5 mob-sm-text" type="button"
                            ...
                            Who are the builders of Queensville Towns & Singles?
                        </button>
                    </h3>
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            Queensville Towns & Singles is being developed by three renowned builders: Aspen Ridge
                            Homes, CountryWide, and Lakeview Homes.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header" id="flush-headingTwo">
                        <button class="accordion-button collapsed fs-5 mob-sm-text" type="button"
                            ...
                            Where is Queensville Towns & Singles located?
                        </button>
                    </h3>
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            Queensville Towns & Singles is located at 19841 Leslie St., Queensville, ON.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header" id="flush-headingThree">
                        <button class="accordion-button collapsed fs-5 mob-sm-text" type="button"
                            ...
                            What types of homes are available at Queensville Towns & Singles?
                        </button>
                    </h3>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            The estimated occupancy for Queensville Towns & Singles is 2025. Please note that this is an
                            estimated date and may be subject to change.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            Queensville offers convenient access to various amenities including schools, shopping
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header" id="flush-headingSix">
                        <button class="accordion-button collapsed fs-5 mob-sm-text" type="button"
                            ...
                            How can I register for Queensville Towns & Singles?
                        </button>
                    </h3>
        ...
        <div class="pt-5">
            ...
            <div class="container ">
                <div class="logo-container d-flex justify-content-center align-items-center">
                    <div>
                        <img src="./images/Logo_aspen_ridge.png" class="regoimg" alt="Aspen Ridge Homes">
                    </div>
                    <div>
                        <img src="./images/countrywide-logo.png" class="regoimg" alt="CountryWide">
                    </div>
                    <div>
                        <img src="./images/lakeview-homes-logo.png" class="regoimg" alt="Lakeview Homes">
                    </div>
                </div>
            </div>
    </section>
            ...
            <div class="pt-5 mt-5 " data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                <div class="row mx-0 ">
                    ...
                    <div class="registertext px-4   d-flex justify-content-center align-items-center text-center mb-0">
                        <p class="sm-text mx-3">Register today and get the first update on Queensville
                        </p>
                    </div>
                        ...
                        <form action="./contactForm.php" method="POST">
                            ...
                            <div class="row ">
                                <p class=" text-muted sm-text text-center mt-0 ">*I consent to receive future
                                    communications about Queensville. I understand I can opt out at anytime by
                                    sending
                                    an email.</p>
                            </div>
                            <div class="row ">
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 justify-content-between ">
                <div class="col-md-5 my-3 fotwidth center-sm px-4 px-md-0">
                    ...
                    <p class=" ">
                        <img src="./images/logo.png" class="navbar-brand pb-1" alt="Queensville logo">
                    </p>
                ...
                <div class="col-md-4  py-md-5 py-4 center-sm px-5 ">
                    <div>
                        ...
                        <div class="list d-block ">
                            ...
                            <p class="mybot ">
                                Location :19841 Leslie St, Queensville, ON
                            </p>
                ...
                <div class="col-md-2 mt-md-5 pt-md-5 mt-sm-0 pt-4 center-sm d-flex  justify-content-center gx-2">
                    <img src="./images/Logo_aspen_ridge.png" class=" footer-logo px-2" alt="Dunsire Developments-logo">
                    <img src="./images/countrywide-logo.png" class="footer-logo px-2" alt="Dunsire Developments-logo">
                    <img src="./images/lakeview-homes-logo.png" class=" footer-logo px-2"
                        alt="Dunsire Developments-logo">
